class Block extends THREE.Object3D {
    ...
    one(p, x, z, add) {
        ...
        this.singleMesh.position.y += (game.tabOfBlocks[cX][cZ] * 50)
...
class Block2 extends THREE.Object3D {
    constructor() {
        super()
        var geometryA = new THREE.BoxGeometry(50, 50, 50);
        var geometryB = new THREE.CylinderGeometry(5, 5, 10, 32);
...
class Block3 extends THREE.Object3D {
    constructor() {
        super()
        var geometryA = new THREE.BoxGeometry(50, 50, 50);
        var geometryB = new THREE.CylinderGeometry(5, 5, 10, 32);
...
class Block4 extends THREE.Object3D {
    constructor() {
        super()
        var geometryA = new THREE.BoxGeometry(50, 50, 50);
        var geometryB = new THREE.CylinderGeometry(5, 5, 10, 32);
